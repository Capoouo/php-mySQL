...
<table width="1190" border="0" align="center">
  <tr class="table">
    ...
    <td width="70"><span class="font12"><a href="registered.html" class="linkstyle-1" >註冊</a>|<a href="login.html" class="linkstyle-1">登入</a></span></td>
  </tr>
</table>
<table width="1190" border="0" align="center" cellpadding="0" cellspacing="0" class="table">
  ...
  <tr>
    <td height="28" colspan="5" class="font3"><form action="viewall_finish" method="post" name="form1" class="regustertextform" id="form1">
	<img src="images/index back.png" width="1190" height="29" /></td>
  </tr>
  <tr>
    <td height="275">
	<?php
	...
	$DB->query("SET NAMES 'utf8'");
	 $sql = "SELECT * FROM game WHERE  No = ".$_SESSION['No']."";
	$result = $DB->query($sql) ;
    $row = $result->fetch_array(MYSQLI_ASSOC);//印出資料
    printf("%s", $row["gamename"]);
?>
</td>
    <td height="275">&nbsp;</td>
    <td height="275">&nbsp;</td>
    <td height="275">&nbsp;</td>
    <td height="275" valign="middle">&nbsp;</td>
  </tr>
  <tr>
    <td height="275">&nbsp;</td>
    <td height="275">&nbsp;</td>
  ...
  <tr>
    <td width="205" height="275">&nbsp;</td>
    <td width="205" height="275">&nbsp;</td>
    <td width="205" height="275">&nbsp;</td>
    <td width="205" height="275">&nbsp;</td>
    <td width="205" height="275" valign="middle"><p>&nbsp;</p></td>
  </tr>
  </form>
</table>
</body>
